...
# que produz um iterador para fornecer as cartas na ordem
# inversa. Ou seja, sem embaralhar, a primeira carta deve
# ser o <K de paus> em vez do <A de copas>, como acontece
