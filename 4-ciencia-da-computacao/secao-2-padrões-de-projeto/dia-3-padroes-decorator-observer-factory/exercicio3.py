...
# setores de vendas, financeiro e suporte. Para respeitar a nova Lei Geral
# de Proteção de Dados, a empresa precisa garantir que as informações
# internas serão expostas somente a quem tem necessidade. Assim devemos
# ter os seguintes perfis de acesso:
